...
// require('query/partyList.view.php');
?>

<header class="bg-gray-800  ">
    <div class="flex justify-around items-center h-14 py-[20px]">
        <a href="index.php" class="flex items-center">
            <img class=" h-10 w-auto" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600" alt="Your Company">
        </a>

        <a href="#">
            <button onclick="createOffice()" class="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 ">Create
                Office</button>
        </a>
    </div>
</header>
...
<body class="font-semibold">
    <div class="createOfficeDiv hidden relative p-4 bg-white rounded-lg shadow sm:p-5">
        ...
        <!-- Modal body -->
        <form action="query/createOffice.php" method="POST">
            <div class="flex flex-col mb-4 ">
                <div class="flex">
                    <div class="input-container">
                        <input placeholder="Title" name="title" class="input-field" type="text">
                    ...
                    <div class="input-container">
                        <input placeholder="Location" name="Location" class="input-field" type="search">
                ...
                <div class="flex">
                    ...
                    <div class="input-container">
                        <input placeholder="password" name="password" class="input-field" type="search">
                ...
                <div class="input-container">
                    <textarea placeholder="Description" name="description" class="input-field" type="text"></textarea>
        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
                <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
                    <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Parties</h2>
                    <p class="font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">organization that
                        coordinates candidates to compete in a particular country's elections</p>
                </div>

                <div class="partyDiv flex flex-col gap-5 mb-6 lg:mb-16 md:grid-cols-2">
                    <ul>
                        <li>
                            <div class="PARTY card-client flex justify-betwen w-full relative">
                                ...
                                <div class="flex flex-col justify-between">
                                    <div>
                                        <p class="name-client">JUBILEE
                                            <span>UHURU KENYATTTA
                                            </span>
                                        </p>
                                    </div>
                                ...
                                <div class="confirmDelete hidden">
                                    <div class="bg-white absolute -right-20 bottom-20">

                                        <div class="relative p-4 text-center bg-white rounded-lg  dark:bg-gray-800 sm:p-5">
                                            <button onclick="deleteParty()" type="button" class="text-gray-400 absolute top-2.5 right-2.5 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="deleteModal">
                                                <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                                                </svg>
                                                <span class="sr-only">Close modal</span>
                                ...
                                <div class="delete  absolute right-6 bottom-6">
                                    <button onclick="deleteParty()" class="flex gap-2 text-red-600 inline-flex items-center hover:text-white border border-red-600 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900"><svg onclick="deleteParty()" style="enable-background:new 0 0 24 24;" version="1.1" height="24" viewBox="0 0 24 24" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                            <g id="info" />
                                            <g id="icons">
                                                <g id="delete">
                                ...
                                <div class="confirmUpdate mb-16 hidden">
                                    <form action="query/updateParty.php" method="POST">
                                ...
                                <div class="update   absolute right-14 bottom-0 ">
                                    <button onclick="updateParty()" class="update flex gap-2 absolute right-24 bottom-6 text-red-600 inline-flex items-center hover:text-white border border-red-600 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900">
                                        <div><svg style="enable-background:new 0 0 24 24;" version="1.1" height="24" viewBox="0 0 24 24" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                                <g id="info" />
                                                <g id="icons">
                    ...
                    <!-- <div class="PARTY card-client flex justify-betwen w-full">
                        <div class="user-picture">
                            <img class="w-72 rounded-lg sm:rounded-none sm:rounded-l-lg" src="images/hansjorg-keller-p7av1ZhKGBQ-unsplash.jpg">
                        </div>

                        <div class="flex flex-col justify-between">
                            <div>
                                <p class="name-client"> UDA
                                    <span>WILLIAM RUTO
                                    </span>
                                </p>
                            </div>
                    ...
                    <!-- <div class="PARTY card-client flex justify-betwen w-full">
                        <div class="user-picture">
                            <img class="w-72 rounded-lg sm:rounded-none sm:rounded-l-lg" src="images/marco-oriolesi-wqLGlhjr6Og-unsplash.jpg" alt="Michael Avatar">
                        </div>

                        <div class="flex flex-col justify-between">
                            <div>
                                <p class="name-client">ODM
                                    <span>WETANGULA
                                    </span>
                                </p>
                            </div>
                    ...
                    <div class="PARTY card-client flex justify-betwen w-full">
                        <div class="user-picture">
                            <img class="w-72 rounded-lg sm:rounded-none sm:rounded-l-lg" src="images/history-in-hd-v_e3Hha4EBA-unsplash.jpg">
                        </div>
...
<script>
    ...
    function deleteParty() {
        document.querySelector('.confirmDelete').classList.toggle('hidden');
    }

    function updateParty() {
        document.querySelector('.confirmUpdate').classList.toggle('hidden');
    }
</script>
