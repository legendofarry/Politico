                ...
                <div class="relative transform overflow-hidden rounded-lg bg-white text-center shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                    <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-center">
                                <h3 class="text-[20px] font-extrabold leading-6 text-gray-900 mb-6" id="modal-title">
                                    CONGRATULATIONS!..</h3>
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">Your vote has been received successfully.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-gray-50 px-4 py-3 flex justify-center  sm:px-6">
                        <form action="candidates.php">
                            <button type="submit" onclick="pageDropdown" class="inline-flex w-full justify-center rounded-md bg-red-600 px-3 py-2 text-[15px] font-semibold text-white shadow-sm hover:bg-red-500 sm:ml-3 sm:w-auto tracking-wide">BACK to VOTING....</button>
                        </form>
                    </div>
                </div>
            </div>
