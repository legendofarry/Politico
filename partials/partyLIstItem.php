<li>
    <div class="PARTY card-client flex  w-full relative">
        ...
        <div class="flex flex-col justify-between">
            <div>
                <p class="name-client"> <?= $party['title'] ?>
            ...
            <div class="bg-white absolute -right-20 bottom-20">
                ...
                <div class="relative p-4 text-center bg-white rounded-lg  dark:bg-gray-800 sm:p-5">
                    ...
                    <p class="mb-4 text-gray-500 dark:text-gray-300">Are you sure you want to delete
                        this item?</p>
                    <div class="py-2">
                        <form action="query/deleteParty.php" method="POST">
                            <label for="title" class="text-black">Title</label>
                            <input type="text" name="title" class="title py-1 px-2 text-black" placeholder="Title">

                            <div class="flex justify-center items-center space-x-4" type="submit">
