<aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
    ...
    <nav class="text-white text-base font-semibold ">
        ...
        <a href="parties.html.php" class="flex items-center text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item">
            <i class="fas fa-align-left mr-3"></i>
            Party
        </a>
        <a href="offices.html.php" class="flex items-center text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item">
