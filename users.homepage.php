...
<section class="">
    <main class="p-4 md:ml-64 h-auto pt-20">
        ...
        <div id="section1" class="officeList grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4 ">
            <?php
        ...
        <div id="section2" class="border-2 border-dashed rounded-lg border-gray-300 dark:border-gray-600 h-fit mb-4 py-4 px-4">
            <?php
