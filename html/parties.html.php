    ...
    <body class="font-['Montserrat'] font-semibold">
        ...
        <main class="mt-[100px]">
            <div class="relative">
                ...
                <button onclick="displayCreatePartyPage()" type="button"
                    class="createBtn inline-flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900"
                    aria-expanded="false">
                ...
                <div
                    class="displayCreatePartyPageDiv hidden absolute left-1/2 z-10 mt-5 flex  w-[60%]  -translate-x-1/2 px-4 ">
                    <div
                        class="  flex-auto overflow-hidden  bg-white text-sm leading-6 shadow-lg ring-1 ring-gray-900/5">
                        <form>
                                        ...
                                        <div class="titleDiv sm:col-span-4">
                                            ...
                                            <div class="mt-2">
                                                <div
                                                    ...
                                                    <span
                                                        class="flex select-none items-center pl-3 text-gray-500 sm:text-sm">symbols
                                                        not allowed</span>
                                                    <input type="text" name="username" id="username"
                                                        autocomplete="username"
                                                        class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6 outline-none">
                                                </div>
                                            </div>
                                        </div>
