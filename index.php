    ...
    <body class="font-['Montserrat'] font-semibold">
        <div class="relative ">
                        ...
                        <div class="names flex justify-between w-full mb-[25px]">
                            <div class="firstName w-[32.5%]">
                                <label for="firstName" class="block text-sm font-medium leading-6 text-gray-900">First
                                    name</label>
                                <div class="mt-2">
                                    <input id="firstName" name="firstName" type="firstName" autocomplete="firstName"
                            ...
                            <div class="lastName w-[32.5%]">
                                <label for="lastName" class="block text-sm font-medium leading-6 text-gray-900">Last
                                    name</label>
                                <div class="mt-2">
                                    <input id="lastName" name="lastName" type="lastName" autocomplete="lastName"
                            ...
                            <div class="otherName w-[32.5%]">
                                <label for="otherName" class="block text-sm font-medium leading-6 text-gray-900">Other
                                    name</label>
                                <div class="mt-2">
                                    <input id="otherName" name="otherName" type="otherName" autocomplete="otherName"
                                        required placeholder="other name"
                                        class="block w-full rounded-md border-0 py-1.5  px-[10px] text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 outline-none">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="contacts flex justify-between mb-[25px]">
                            ...
                            <div class="phoneNumber w-[49%]">
                                <label for="phoneNumber" class="block text-sm font-medium leading-6 text-gray-900">Phone
                                    Number</label>
                                <div class="mt-2">
                                    <input id="phoneNumber" name="phoneNumber" type="number" autocomplete="phoneNumber"
                                        required placeholder="(+254) 0742 *** ***"
                                        class="block w-full rounded-md border-0 py-1.5 px-[10px] text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 outline-none">
                                </div>
                            </div>
                        </div>
            ...
            <div class="onlineUsers py-24 sm:py-32 absolute top-0 left-[1%]">
                ...
                <button
                    class="onlineBtn inline-flex w-full justify-center rounded-full bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 sm:ml-3 sm:w-auto ring-4"
                    onclick="onlineUsers()">Online</button>
            </div>
